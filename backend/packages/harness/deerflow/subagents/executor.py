...
class SubagentExecutor:
    ...
    def __init__(
        ...
        inherited_mmkb_configurable: Mapping[str, Any] | None = None,
        inherited_mmkb_context: Mapping[str, Any] | None = None,
        ...
        Args:
            ...
            inherited_mmkb_configurable: Narrow bearer/public URL subset needed
                by delegated MMKB RAG tools.
            inherited_mmkb_context: Narrow MMKB identity/public URL subset
                propagated to the delegated runtime context.
        ...
        self.inherited_mmkb_configurable = dict(inherited_mmkb_configurable or {})
        self.inherited_mmkb_context = dict(inherited_mmkb_context or {})
    ...
    async def _aexecute_admitted(self, task: str, result_holder: SubagentResult | None = None) -> SubagentResult:
        ...
        try:
            ...
            if self.inherited_mmkb_configurable:
                run_config["configurable"] = dict(self.inherited_mmkb_configurable)
            ...
            context: dict[str, Any] = dict(self.inherited_mmkb_context)
            if self.thread_id:
